    ...
    def display_plots(self):
        ...
        if len(self.set_models) >= 1:
            ...
            for imod in range(len(self.set_models)):
                ...
                ax.set_yticks(ticks = x, labels = self.axis_label[imod])
                ax.set_xticks(ticks = x, labels = self.axis_label[imod])
                ...
                cmap.set_under('white')
                ax2.set_yticks(ticks=x, labels=self.axis_label[imod])
                ax2.set_xticks(ticks=x, labels=self.axis_label[imod])
        ...
        if len(self.set_models) >= 2:
            ...
            cmap.set_under('white')
            ax.set_yticks(ticks = x, labels = self.axis_label2)
            ax.set_xticks(ticks = x, labels = self.axis_label2)
            ax.tick_params(axis='x', labelrotation=90)
            ax.invert_yaxis()
